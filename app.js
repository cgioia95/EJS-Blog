...
app.get("/", function(req,res){
  ...
  res.render("home", {homeInit: homeStartingContent, posts: posts});
...
app.get('/posts/:title', function (req, res) {
  ...
  let reqTitle = _.lowerCase(req.params.title);
  var match = false;

  posts.forEach(function(post){
    const displayTitle = post.title;
    const displayContent = post.content;
    const storedTitle = _.lowerCase(displayTitle);
    ...
    if (match){
    res.render("post", {header: displayTitle, content: displayContent});
  }
  });
});
